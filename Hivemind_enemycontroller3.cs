...
public class Hivemind_enemycontroller3 : MonoBehaviour {
	...
	void Update () {
		...
		foreach (GameObject enemy in enemies) {
			...
			Vector2Int finalpath = new Vector2Int (0, -3);
			...
			if (!float.IsPositiveInfinity(Max)) {
				...
				Vector2Int newpath = new Vector2Int (0, 3);
	...
	float minimax(GameObject enemy, Vector2Int pathe, Vector2Int pathp, int depth, float alpha, float beta, bool isMax, int plenergy){
        ...
        if (isMax) {
            ...
            Vector2Int newpath = (pathe + new Vector2Int(0, 3));
            ...
            newpath = (pathe + new Vector2Int(3, 0));
            hit = Physics2D.Raycast(enemy.transform.position, newpath, newpath.magnitude, wallmask);
            float utility2;
            if (hit.collider != null)
            {
            ...
            newpath = (pathe + new Vector2Int(0,-3));
			hit = Physics2D.Raycast (enemy.transform.position, newpath, newpath.magnitude, wallmask);
			float utility3;
			if (hit.collider != null) {
				utility3 = Mathf.NegativeInfinity;
            ...
            newpath = (pathe + new Vector2Int(2,1));
			hit = Physics2D.Raycast (enemy.transform.position, newpath, newpath.magnitude, wallmask);
			float utility5;
			if (hit.collider != null) {
				utility5 = Mathf.NegativeInfinity;
            ...
            newpath = (pathe + new Vector2Int(1,-2));
			hit = Physics2D.Raycast (enemy.transform.position, newpath, newpath.magnitude, wallmask);
			float utility12;
			if (hit.collider != null) {
				utility12 = Mathf.NegativeInfinity;
